...
# nb d'handle et handle le plus court et triage par longueur des handles
...
def select_epenser(journalists)
    var4 = journalists.index("@epenser")
    puts "Epenser se trouve a la position #{var4}"
end
...
# nb d'handle commencent par une lettre capital
def upper(journalists)
    capital = journalists.count{|maj| maj[1][/[A-Z]/]}
